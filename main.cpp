...
//	    cout << "dr = " << *dr << endl;
    ...
    if (false || (argc >= 2 && string(argv[1]) == "model35_induce"))
    {
	auto uvars = systemsSetVar;
	auto hrsel = [](const HistoryRepa& hr, const SizeList& ll)
	{
    ...
    if (false || (argc >= 2 && string(argv[1]) == "model100_induce"))
    {
	auto uvars = systemsSetVar;
	auto hrsel = [](const HistoryRepa& hr, const SizeList& ll)
	{
    ...
    if (false || (argc >= 2 && string(argv[1]) == "model35_bitmap"))
    {
	auto uvars = systemsSetVar;
	auto single = histogramSingleton_u;
	auto aahr = [](const System& uu, const SystemRepa& ur, const Histogram& aa)
    ...
    if (false || (argc >= 2 && string(argv[1]) == "model100_bitmap"))
    {
	auto uvars = systemsSetVar;
	auto single = histogramSingleton_u;
	auto aahr = [](const System& uu, const SystemRepa& ur, const Histogram& aa)
